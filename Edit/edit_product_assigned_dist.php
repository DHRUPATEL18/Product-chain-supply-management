...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $qr = "UPDATE product_assigned_dist SET batch_id = ?, product_id = ?, quantity = ?, status = ?,assigned_at = NOW() WHERE id = ?";
...
$qr = "SELECT * FROM product_assigned_dist WHERE id = ?";
$stmt = mysqli_prepare($cn, $qr);
...
<form method="post">
    <h2>Edit Product Assigned Dist</h2>
